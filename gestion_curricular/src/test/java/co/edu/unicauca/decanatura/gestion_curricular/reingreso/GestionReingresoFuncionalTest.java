...
/**
 * ============================================================
 * PRUEBAS FUNCIONALES - GESTIÓN DE REINGRESO
 * ============================================================
 *
 * Objetivo: Validar FLUJOS COMPLETOS DE NEGOCIO del módulo de Reingreso.
 ...
 * 1. Flujo completo de solicitud de Reingreso por estudiante
...
class GestionReingresoFuncionalTest {
    ...
    // ==================== FLUJO 1: SOLICITUD COMPLETA DE REINGRESO ====================

    @Test
    @DisplayName("Funcional 1: Flujo completo - Estudiante solicita Reingreso")
    void testFlujoCompletoSolicitudEstudiante() throws Exception {
        /*
         * FLUJO DE NEGOCIO:
         * 1. Estudiante crea una solicitud de Reingreso
    ...
    void testFlujoValidacionFuncionario() throws Exception {
        ...
        // Paso 4: Funcionario aprueba la solicitud (usando ID 4 que existe en BD de test)
    ...
    void testFlujoEvaluacionCoordinador() throws Exception {
         ...
         * 3. Coordinador evalúa la solicitud
        ...
        // Paso 3: Coordinador aprueba la solicitud (usando ID 3 que existe en BD de test)
        String jsonAprobacion = """
            {
                "idSolicitud": 3,
    ...
    void testFlujoEmisionSecretaria() throws Exception {
         ...
         * 4. Secretaria sube el archivo PDF si es necesario
         * 
        ...
        // Paso 2: Secretaria consulta solicitud específica (usando ID 3 que existe en BD de test)
        mockMvc.perform(get("/api/solicitudes-reingreso/listarSolicitud-Reingreo/3"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
    ...
    void testFlujoConsultaEstudiante() throws Exception {
         ...
         * 2. Estudiante consulta el estado de sus solicitudes de Reingreso
    ...
    void testFlujoCompletoExitoso() throws Exception {
        ...
        // Paso 3: Funcionario aprueba solicitud (usando ID 4 que existe en BD de test)
