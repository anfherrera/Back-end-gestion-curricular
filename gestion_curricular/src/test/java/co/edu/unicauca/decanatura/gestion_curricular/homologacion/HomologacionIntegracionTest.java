...
/**
 * ============================================================
 * PRUEBAS DE INTEGRACIÓN - REST API HOMOLOGACIÓN
 * ============================================================
 * 
 * Objetivo: Validar el correcto funcionamiento de los endpoints
 * del módulo Homologación.
 * 
...
class HomologacionIntegracionTest {
    ...
    @Test
    @DisplayName("Test 1: Listar todas las solicitudes de Homologación")
    void testListarSolicitudesHomologacion() throws Exception {
    ...
    @Test
    @DisplayName("Test 6: Crear solicitud de Homologación - Valida endpoint POST")
    void testCrearSolicitudHomologacion() throws Exception {
        String jsonRequest = """
            {
