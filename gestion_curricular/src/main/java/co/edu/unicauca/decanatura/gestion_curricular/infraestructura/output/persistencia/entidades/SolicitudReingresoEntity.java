...
public class SolicitudReingresoEntity extends SolicitudEntity {
    ...
    public SolicitudReingresoEntity(Integer id_solicitud, String nombre_solicitud, String periodo_academico, Date fecha_ceremonia, Date fecha_registro_solicitud,
