...
public class BeanConfiguration {
    ...
    @Bean
    public GestionarSolicitudCursoVeranoCUAdapter GestionarSolicitudCursoVeranoInt(GestionarSolicitudCursoVeranoGatewayIntPort objGestionarSolicitudGateway,
