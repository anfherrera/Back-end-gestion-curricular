...
public class SolicitudReingresoDTORespuesta extends SolicitudDTORespuesta{
    ...
    public SolicitudReingresoDTORespuesta(Integer id_solicitud, String nombre_solicitud, String periodo_academico, Date fecha_registro_solicitud,
        ...
        super(id_solicitud, nombre_solicitud, periodo_academico, fecha_registro_solicitud, estado_actual, objUsuario, documentos);
    }  
}
