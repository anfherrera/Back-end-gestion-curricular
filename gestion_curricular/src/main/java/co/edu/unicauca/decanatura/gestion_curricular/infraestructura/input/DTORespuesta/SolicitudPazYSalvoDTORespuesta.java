...
public class SolicitudPazYSalvoDTORespuesta extends SolicitudDTORespuesta  {
    ...
    public SolicitudPazYSalvoDTORespuesta (Integer id_solicitud, String nombre_solicitud, String periodo_academico, Date fecha_ceremonia,Date fecha_registro_solicitud,
        ...
        super(id_solicitud, nombre_solicitud, periodo_academico, fecha_ceremonia,fecha_registro_solicitud, estadosSolicitud, objUsuario, documentos, categoria, tipo_solicitud);
    }  
}
